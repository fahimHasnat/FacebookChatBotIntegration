...
export declare class FacebookMessagingAPIClient {
     ...
     * @return {Promise<any>}
     */
    markSeen(id: string, cb?: Function): Promise<void> | Promise<{}>;
    /**
     ...
     * @return {any}
     */
    toggleTyping(id: string, toggle: boolean | Function, cb?: Function): Promise<void> | Promise<{}>;
    /**
     ...
     * @return {Promise<any>}
     */
    getUserProfile(id: string, fieldsArray: string[], cb?: Function): Promise<void> | Promise<{}>;
