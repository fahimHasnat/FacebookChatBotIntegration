...
export declare class FacebookProfileAPIClient {
     ...
     * @return
     */
    setGreetingMessage(greetingMessage: string, cb?: Function): Promise<void> | Promise<{}>;
    /**
     ...
     * @return
     */
    setGetStartedAction(getStartedPayload: string, cb?: Function): Promise<void> | Promise<{}>;
    /**
     ...
     * @return
     */
    setPersistentMenu(menuEntries: Object[], cb?: Function): Promise<void> | Promise<{}>;
