responses = {
    ...
    "Texts": [
        { "id": 11, "referred_to": { "goto": "Inputs", "id": 150 }, "type": "text", "text": "Please enter any GP number" },
        { "id": 12, "referred_to": { "goto": "Inputs", "id": 151 }, "type": "text", "text": "Please enter an amount" },
        { "id": 16, "referred_to": {}, "type": "text", "text": "Thank you for staying with Grameenphone" },
        { "id": 17, "referred_to": { "goto": "Texts", "id": 12 }, "type": "text", "text": "Please enter a 11 digit valid GP number" },
